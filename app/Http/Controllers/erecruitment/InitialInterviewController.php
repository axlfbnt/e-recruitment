...
class InitialInterviewController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->expectsJson()) {
            $data = VwInitialInterview::all();

            return DataTables::of($data)
                ->addIndexColumn()
                ->addColumn('action', function ($data) {
                    return view('erecruitment.initial-interview.action')->with('data', $data);
                })
                ->make(true);
        }
        return view('erecruitment.initial-interview.index');
    }
    ...
    public function getApplicantsData($id)
    {
        ...
        $applicants = VwInputApplicantion::where('vacancy', $id)
            ...
            ->where('last_stage', 'Initial Interview')
            ->paginate(10);
        ...
        return view('erecruitment.initial-interview.indexApplicants', [
            'jobVacancyId' => $id,
