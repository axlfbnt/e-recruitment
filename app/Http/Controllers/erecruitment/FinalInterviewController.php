...
class FinalInterviewController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('erecruitment.final-interview.index');
    }
    ...
    public function getApplicantsData($id)
    {
        ...
        $applicants = VwInputApplicantion::where('vacancy', $id)
            ...
            ->where('last_stage', 'Final Interview')
            ->paginate(10);
        ...
        return view('erecruitment.final-interview.indexApplicants', [
            'jobVacancyId' => $id,
