                        ...
                        <div class="page-title-box mb-1 mt-2">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-2">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('administrative-selection.index') }}">Administrative Selection</a>
                                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="header-title mb-0">Administrative Selection</h4>
                                </div>
                                ...
                                <hr>
                                <table id="administrativeselection-datatable" class="table table-striped w-100 nowrap">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Vacancy Code</th>
...
@section('script')
    @include('erecruitment.administrative-selection.script')
@endsection
