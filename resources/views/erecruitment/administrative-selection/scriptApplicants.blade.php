<script>
    $(document).ready(function() {
        ...
        $('.button-pass').on('click', function() {
            handleBulkAction(vacancyId, 'Psychological Test');
        });
        $('.button-reject').on('click', function() {
            handleBulkAction(vacancyId, 'Reject Administrative Selection');
        });
        ...
        $('body').on('click', '[id^=passMenu]', function() {
            ...
            handleBulkAction(vacancyId, 'Psychological Test', [applicantId]);
        });
        ...
        $('body').on('click', '[id^=failMenu]', function() {
            ...
            handleBulkAction(vacancyId, 'Reject Administrative Selection', [applicantId]);
        });
    });
</script>
