                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-2">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('followup-interview.index') }}">Follow-up Interview</a></li>
                            ...
                            <div class="d-flex justify-content-start align-items-center">
                                ...
                                <div>
                                    <button type="button" class="btn btn-success ms-2 button-pass"
                                        ...
                                        data-bs-placement="top" data-bs-title="Pass">
                                    ...
                                    <button type="button" class="btn btn-info ms-2 button-invitation"
                                        {{ $applicants->isEmpty() ? 'disabled' : '' }} data-bs-toggle="modal"
                                        data-bs-target="#">
                                        <i class="ri-chat-forward-line me-1"></i> Interview Invitation
                                    </button>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-1 text-muted"><strong>Applied date:</strong>
                                                        ...
                                                        {{ $applicant->interview_status ?? 'Not Available' }}
                                                    </p>
                                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Import Psychological Test Status</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('followup-interview.import') }}" method="POST"
...
@section('script')
    @include('erecruitment.followup-interview.scriptApplicants')
@endsection
