                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-2">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('psychological-test.index') }}">Psychological Test</a></li>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-1 text-muted"><strong>Applied date:</strong>
                                                        ...
                                                        {{ $applicant->psychological_status ?? 'Not Available' }}
                                                    </p>
                                                </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('psychological-test.import') }}" method="POST"
...
@section('script')
    @include('erecruitment.psychological-test.scriptApplicants')
@endsection
