                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-2">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="ri-home-4-line"></i>
                                            Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('offering.index') }}">Offering</a></li>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-1 text-muted"><strong>Applied date:</strong>
                                                        ...
                                                        {{ $applicant->offering_status ?? 'Not Available' }}
                                                    </p>
                                                </div>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item text-info"
                                                                    id="mcuMenu{{ $applicant->applicant_id }}"
                                                                    data-applicant-id="{{ $applicant->applicant_id }}">
                                                                    <i class="ri-chat-forward-line me-1"></i>Medical Check
                                                                    Up Invitation
                                                                </a>
                                                            </li>
                                                        </ul>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('offering.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
...
@section('script')
    @include('erecruitment.offering.scriptApplicants')
@endsection
