        ...
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="{{ route('home') }}" class="logo-dark">
                    <span class="logo-lg">
                        <img src="{{ asset('images/e-recruitment.png') }}" alt="dark logo">
                    </span>
                    <span class="logo-sm">
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('images/flags/italy.jpg') }}" alt="user-image" class="me-1"
                            height="12">
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{ asset('images/flags/spain.jpg') }}" alt="user-image" class="me-1"
                            height="12">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                    ...
                    <div class="p-2">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ asset('images/brands/behance.png') }}" alt="Behance">
                                    <span>Behance</span>
                                </a>
                            </div>
                        </div> <!-- end row-->
            ...
            <li class="dropdown me-md-2">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        ...
                        <h6 class="my-0 fw-normal">{{ Auth::user()->title }}</h6>
                    </span>
                </a>
