...
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="header-title mb-0">Manage Template Form A3 (Psychological Test)</h4>
                                    <button type="button" class="btn btn-success rounded-pill button-add"
                                        data-bs-toggle="modal" data-bs-target="#addtemplateformA3-modal">
                                ...
                                <hr>
                                <table id="templateforma3-datatable" class="table table-striped w-100 nowrap">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Template Name</th>
    ...
    <!-- Add Form A3 modal content -->
    <div id="addtemplateformA3-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form class="needs-validation ps-3 pe-3" novalidate>
                        ...
                        <div id="evaluation-container">
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <label for="intelligence-aspect[]" class="form-label">Intelligence Aspect</label>
                                    <input class="form-control" name="intelligence-aspect" type="text" required
                                        placeholder="Intelligence Aspect">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" name="definition" type="text" required
                                ...
                                <div class="col-md-3">
                                    <label for="job-implication[]" class="form-label">Job Implication</label>
                                    <input class="form-control" name="job-implication" type="text" required
                                        placeholder="Job Implication">
                                    <div class="invalid-feedback">
                        ...
                        <div class="d-flex justify-content-end mb-4 mt-3">
                            <button type="button" id="closeModalBtn" class="btn btn-soft-warning me-2"
                                onclick="resetAddFormA3()" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-soft-danger me-2"
                                onclick="resetAddFormA3()">Reset</button>
    ...
    <!-- Edit Form A3 modal content -->
    <div id="edittemplateformA3-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
    ...
    <div class="modal fade" id="deletetemplateforma3-modal" tabindex="-1" aria-labelledby="deleteModalLabel"
        aria-hidden="true">
...
@section('script')
    @include('erecruitment.template-forma3.script')
@endsection
